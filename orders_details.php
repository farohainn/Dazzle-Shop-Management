...
<head>
  ...
  <title>Dazzle Ordering System : Orders Details</title>
  <!-- Bootstrap -->
    ...
    try {
      ...
      $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $stmt = $conn->prepare("SELECT * FROM tbl_orders_a170567, tbl_staffs_a170567_final,
          tbl_customers_a170567_pt2 WHERE
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      <div class="form-group">
        ...
        <button class="btn btn-default" type="submit" name="addproduct" onclick="return validateForm();"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add Product</button>
