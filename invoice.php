...
try {
  ...
  $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $stmt = $conn->prepare("SELECT * FROM tbl_orders_a170567, tbl_staffs_a170567_final,
      tbl_customers_a170567_pt2, tbl_orders_details_a170567 WHERE
      tbl_orders_a170567.fld_staff_num = tbl_staffs_a170567_final.fld_staff_num AND
      tbl_orders_a170567.fld_customer_num = tbl_customers_a170567_pt2.fld_customer_num AND
      tbl_orders_a170567.fld_order_num = tbl_orders_details_a170567.fld_order_num AND
      tbl_orders_a170567.fld_order_num = :oid");
...
<div class="col-xs-6 text-center">
  <br>
    <img src="logoz.jpg" width="60%" height="60%">
</div>
  ...
  <div class="col-xs-5">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4>From: Dazzle Sdn. Bhd.</h4>
      </div>
      <div class="panel-body">
        <p>
        1-73A & 61 kenanga wholesale city, <br>
        2 jalan gelugor off jalan kenanga<br>
...
<table class="table table-bordered">
  ...
  try {
    $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
    $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
      $stmt = $conn->prepare("SELECT * FROM tbl_orders_details_a170567,
        tbl_products_a170567_pt2 where 
        tbl_orders_details_a170567.fld_product_num = tbl_products_a170567_pt2.fld_product_num AND
        fld_order_num = :oid");
    $stmt->bindParam(':oid', $oid, PDO::PARAM_STR);
      $oid = $_GET['oid'];
    $stmt->execute();
