...
<head>
  ...
  <title>Dazzle Ordering System : Customers</title>
  <!-- Bootstrap -->
  ...
  <div class="row">
    ...
    <form action="customers.php" method="post" class="form-horizontal">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-9">
          <input name="country" type="text" class="form-control" id="country" placeholder="Country" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_state']; ?>" required>
        </div>
        </div>
      <div class="form-group">
          ...
          <div class="radio">
              <label>
              <input name="gender" type="radio" id="custgender" value="Male" <?php if(isset($_GET['edit'])) if($editrow['fld_customer_gender']=="Male") echo "checked"; ?> required> Male
            </label>
          </div>
          <div class="radio">
              <label>
                <input name="gender" type="radio" id="custgender" value="Female" <?php if(isset($_GET['edit'])) if($editrow['fld_customer_gender']=="Female") echo "checked"; ?>> Female
            </label>
            </div>
          </div>
      </div>
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $stmt = $conn->prepare("SELECT * FROM tbl_customers_a170567_pt2 LIMIT $start_from, $per_page");
        $stmt->execute();
      ...
      <tr>
        ...
        <td><?php echo $readrow['fld_customer_state']; ?></td>
        <td><?php echo $readrow['fld_customer_gender']; ?></td>
        <td><?php echo $readrow['fld_customer_phone']; ?></td>
        <td>
          <a <?php if(isset($_SESSION["lvl"])){ if($_SESSION["lvl"]=="normal") echo "disabled"; } ?> href="customers.php?edit=<?php echo $readrow['fld_customer_num']; ?>"class="btn btn-success btn-xs" role="button"> Edit </a>
          <a <?php if(isset($_SESSION["lvl"])){ if($_SESSION["lvl"]=="normal") echo "disabled"; } ?> href="customers.php?delete=<?php echo $readrow['fld_customer_num']; ?>" onclick="return confirm('Are you sure to delete?');" class="btn btn-danger btn-xs" role="button">Delete</a>
        </td>
      </tr>
      <?php
      }
